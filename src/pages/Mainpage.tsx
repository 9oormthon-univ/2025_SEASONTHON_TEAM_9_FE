...
const Mainpage = () => {
  ...
  useEffect(() => {
    ...
    else if (lastSegment === "contents")
      setbtnclick([false, true, false, false]);
    else if (lastSegment === "community")
      setbtnclick([false, false, true, false]);
  ...
  const btnchange = (i: number) => {
    const newarr: [boolean, boolean, boolean, boolean] = [
      false,
      false,
      false,
      false,
